...
// &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
  _renderWorkout(workout) {
    console.log("Render wwork");
    let html = `
      <li class="workout workout--${workout.type}" data-id="${workout.id}">
        <h2 class="workout__title" id="hh">${workout.description}
        <button class="remove" style="position:fixed;margin:5px;margin-left:200px;">X</button></h2>
